...
# ======================================================
# Step 26: This script updates the 'mcountry' field in the 'analysis_ready_group_roster' dataset
...
# ======================================================
# Step 27: Assign Regions to Countries in `analysis_ready_group_roster`
...
# ======================================================
# Step 28: Assign Regions to Countries in analysis_ready_group_roster2
...
# ======================================================
# Step 29: Update `PRO02A` and `PRO03` Based on `ryear`
# - If `ryear == 2024`: 
#   - Copy `PRO02A` → `PRO03`
...
# ======================================================
# Step 30: Overwrite `group_roster` Values Using JDC Data
...
library(readr)
# ======================================================
# Step 31: Recodes ISO country codes in `PRO03C` in `analysis_ready_group_roster` 
...
group_roster <- read.csv(group_roster_file)
group_roster <- group_roster %>%
  mutate(PRO03C = case_when(
    PRO03C == "SOM" ~ "Somalia",
    PRO03C == "LAO" ~ "Laos",
    PRO03C == "ITA" ~ "Italy",
    PRO03C == "PER" ~ "Peru",
    PRO03C == "LBN" ~ "Lebanon",
    PRO03C == "BFA" ~ "Burkina Faso",
    PRO03C == "CMR" ~ "Cameroon",
    PRO03C == "COD" ~ "Democratic Republic of the Congo",
    PRO03C == "HND" ~ "Honduras",
    PRO03C == "SLV" ~ "El Salvador",
    PRO03C == "ZMB" ~ "Zambia",
    PRO03C == "MOZ" ~ "Mozambique",
    PRO03C == "CAF" ~ "Central African Republic",
    PRO03C == "TCD" ~ "Chad",
    PRO03C == "COG" ~ "Republic of the Congo",
    PRO03C == "KEN" ~ "Kenya",
    PRO03C == "ETH" ~ "Ethiopia",
    PRO03C == "DJI" ~ "Djibouti",
    PRO03C == "BGD" ~ "Bangladesh",
    PRO03C == "CHL" ~ "Chile",
    PRO03C == "COL" ~ "Colombia",
    PRO03C == "ECU" ~ "Ecuador",
    PRO03C == "IRQ" ~ "Iraq",
    ...
    PRO03C == "JOR" ~ "Jordan",
    PRO03C == "PAN" ~ "Panama",
    PRO03C == "SYR" ~ "Syrian Arab Republic",
    PRO03C == "MAR" ~ "Marshall Islands",
    PRO03C == "GHA" ~ "Ghana",
    PRO03C == "ZWE" ~ "Zimbabwe",
    PRO03C == "MLI" ~ "Mali",
    PRO03C == "BWA" ~ "Burundi",  # Assuming BWA intended for Burundi
    PRO03C == "MRT" ~ "Mauritania",
    PRO03C == "MWI" ~ "Malawi",
    PRO03C == "AZE" ~ "Azerbaijan",
    PRO03C == "TUR" ~ "Turkiye",
    PRO03C == "ZAF" ~ "South Africa",
    TRUE ~ PRO03C  # Preserve already full or unmatched values
  ))
# Save the updated group_roster back to file
write.csv(group_roster, group_roster_file, row.names = FALSE)
# ======================================================
...
# ======================================================
# Step 37: Write and Clean PRO12 roster for challenges and use of recommendations
# ======================================================
...
# ======================================================
# Step 38: Write and Clean GRF Repeat Pledge File (Without Increasing Rows)
# ======================================================
...
# ======================================================
# Step 39: Data Cleaning: Merge Unique PRO18 Variables into Analysis Ready Group Roster
# ======================================================
...
# ======================================================
# Step 40: Standardizes response variables in `analysis_ready_main_roster`
# to numeric values: 01 = YES, 02 = NO, 08 = DON'T KNOW, 09 = NO RESPONSE.
...
# ======================================================
# Step 43: Backup Analysis Ready Files with a Timestamp
# ======================================================
# Load necessary libraries
library(readxl)
library(dplyr)
...
# ======================================================
# Step 45: Remove specified variables from main roster and save as "main.csv"
# ======================================================
...
# ======================================================
# Step 46: Create final version of group_roster as `pro.csv`
...
# ======================================================
# Step 47: Backup Analysis Ready Files with a Timestamp
# ======================================================
